    ...
    <Container>
      <Content>
        ...
        >
          ...
          <Text>{lng === 'en' ? 'Revision' : '개정'} 2022. 3. 22</Text>
        </Box>
        {type === 'policy' && (
          <>
            {lng === 'ko' && <PolicyKo COMPANY={getCompanyName()} CS_EMAIL={CS_EMAIL} />}
            {lng === 'en' && <PolicyEn COMPANY={getCompanyName()} CS_EMAIL={CS_EMAIL} />}
          </>
        )}
        {type === 'privacy' && (
          <>
            {lng === 'ko' && <PrivacyKo COMPANY={getCompanyName()} CS_EMAIL={CS_EMAIL} />}
            {lng === 'en' && <PrivacyEn COMPANY={getCompanyName()} CS_EMAIL={CS_EMAIL} />}
          </>
        )}
      </Content>
    </Container>
